  ...
  return (
    ...
    {isShuffling && fakeDisplay && (
      ...
      >
        ...
        <div className="mx-auto max-w-md bg-white/80 border border-[#e6d4b0] rounded-xl p-3 shadow">
      ...
      {!isShuffling && revealedWinner && (
        <div className="text-center mb-6 winner-card">
          ...
          {/* 留言內容卡片 */}
          <div className="mx-auto max-w-md bg-white/95 border border-[#e6d4b0] rounded-2xl p-5 shadow-lg">
      ...
      <div className="bg-[#fbf4eb] p-4 rounded-2xl shadow-md mb-6 max-w-xl mx-auto">
        {winnerList.length === 0 ? (
      ...
      <div className="bg-[#fbf4eb] p-4 rounded-2xl shadow-md  max-w-xl mx-auto">
        <ul className="space-y-3">
          {messages.map(m => (
            <li key={m.id}>
